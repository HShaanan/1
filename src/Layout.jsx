          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="text-center md:text-right">
              ...
              <nav className="flex flex-col gap-2" aria-label="קטגוריות פופולריות">
                <Link to={createPageUrl("Browse?q=חומוס")} className="text-white/60 hover:text-white transition-colors text-sm">חומוס</Link>
                <Link to={createPageUrl("Browse?q=פיצה")} className="text-white/60 hover:text-white transition-colors text-sm">פיצה</Link>
                <Link to={createPageUrl("Browse?q=פלאפל")} className="text-white/60 hover:text-white transition-colors text-sm">פלאפל</Link>
                <Link to={createPageUrl("Browse?q=המבורגר")} className="text-white/60 hover:text-white transition-colors text-sm">המבורגר</Link>
                <Link to={createPageUrl("Browse?q=אסייתי")} className="text-white/60 hover:text-white transition-colors text-sm">אסייתי</Link>
