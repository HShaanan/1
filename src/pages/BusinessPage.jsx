...
export default function BusinessPageView() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden" dir="rtl" style={{
      ...
      {/* פס קריאה לבעלות - לגולשים לא מחוברים או עסקים ללא בעלים */}
      {(!user || (!businessPage?.business_owner_email || businessPage?.business_owner_email === '4170531@gmail.com')) && businessPage?.url_slug !== 'fruitost' && (
