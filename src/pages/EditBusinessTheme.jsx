...
import {
  Save, AlertTriangle, Loader2, Palette, ChevronLeft
} from "lucide-react";
import { createPageUrl } from "@/utils";
import ColorPicker from "@/components/theme/ColorPicker";

export default function EditBusinessThemePage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setSuccessMessage("ערכת הנושא נשמרה בהצלחה!");
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <Card>
          ...
          <CardContent>
            <ColorPicker
              value={themeSettings || {}}
              onChange={(newTheme) => setThemeSettings(newTheme)}
            />
          </CardContent>
        </Card>
      </div>
